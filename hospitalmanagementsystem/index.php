...
<title>Murugu Health Services</title>
...
<div class="container">
	...
	<span>Hello <?php echo $s['username']; echo " !";?></span>
                            ...
                            echo $new; 
							?></span></span>
							<span style="margin-left:230px">Murugu Services</span>
    ...
    <div class="row">
    	<div class="col-sm-12">
        	<div class="footer bg-white">
            	<div class="copyright">
                	<p align="center" style="padding-top:10px;">Copyright &copy; Murugu Health 2019 &nbsp;&nbsp;&nbsp;<span style="color:#CC0033">Murugu Services</span></p>
                </div>
            </div>
        </div>
    </div>

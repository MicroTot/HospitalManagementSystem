...
<link href="css/style1.css" rel="" type="text/css" />
    ...
    <div class="row">
    	<div class="col-sm-12">
        	<div class="footer bg-white">
            	<div class="copyright">
                	<p align="center" style="padding-top:10px;">Copyright &copy; Murugu 2019 &nbsp;&nbsp;&nbsp;<span style="color:#CC0033">Murugu Health Services</span></p>
                </div>
            </div>
        </div>
    </div>

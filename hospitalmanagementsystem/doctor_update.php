	...
	<div class="row">
    	<div class="col-sm-12">
        	<div class="header bg-white">            		
            			<h3 style="background:#229954;padding:20px;color:#FFFFFF;margin:0px">
	<span>Hello!</span><span style="margin-left:350px">Murugu Services</span>
  	...
  	<div class="row">
		...
		<div class="col-sm-1">
			...
			<div style="background-color:white; width:500px; border-style:groove; border-color:#FF0099">
				<div style="background-color:#229954; width:494px; padding-top:1px; padding-bottom:1px;">
    ...
    <div class="row">
    	<div class="col-sm-12">
        	<div class="footer bg-white">
            	<div class="copyright">
                	<p align="center" style="padding-top:10px;">Copyright &copy; H.M.S 2017 &nbsp;&nbsp;&nbsp;<span style="color:#CC0033">Murugu health Services</span></p>
                </div>
            </div>
        </div>
    </div>
